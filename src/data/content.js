export const tools = [
  ...
  },
  {
    ...
    name: 'Balance Game',
    nameKo: '연예인 이상형 월드컵',
    oneLiner: '연예인 후보를 1:1로 고르며 전체 인원에서 시작해 최종 1명을 뽑는 도구',
    oneLinerEn: 'Pick celebrity candidates one-on-one from the full roster until one final winner remains.',
    why: '이상형 선택을 재미있게 해보려고, 후보를 단계적으로 압축해서 결승까지 가는 월드컵 형식 도구를 만들었습니다.',
    whyEn: 'I built this to make ideal-type picks fun through a bracket-style tournament flow.',
    how: ['8강 또는 16강을 선택합니다.', '매치마다 두 후보 중 한 명을 선택합니다.', '결승 우승자를 확인하고 다시 시작할 수 있습니다.'],
    learned: '토너먼트형 도구는 단계 표시와 즉시 반응이 사용자 몰입에 가장 중요했습니다.',
    openUrl: '/balance-game/'
  },
  {
    slug: 'ideal-mbti-finder',
    category: 'random-recommend',
    name: 'Ideal MBTI Finder',
    nameKo: '이상형 MBTI 찾기',
    oneLiner: '질문 선택으로 내가 선호하는 이상형 MBTI를 4글자로 찾는 도구',
    oneLinerEn: 'Find your preferred ideal-type MBTI in four letters by answering choice-based questions.',
    why: '내가 어떤 성향의 사람을 만나면 잘 맞을지 MBTI를 미리 알고 싶어서 이 도구를 만들었습니다.',
    whyEn: 'I built this tool to preview which MBTI personality type may fit me best in a relationship.',
    how: ['질문마다 더 끌리는 선택지를 고릅니다.', '모든 질문에 답한 뒤 결과 보기를 누릅니다.', '축별 점수와 최종 MBTI 결과를 확인합니다.'],
    learned: '선택형 심리 도구는 질문 문장을 짧고 상황 중심으로 구성할 때 응답 속도와 몰입도가 높았습니다.',
    openUrl: '/ideal-mbti-finder/'
  },
  {
